...
| `citizen/Agent` | `citizen-class` | `sim-lib-agent` | citizen class constructor surface |
| `citizen/AgentComponent` | `citizen-class` | `sim-lib-agent` | citizen class constructor surface |
| `citizen/AgentFabric` | `citizen-class` | `sim-lib-agent` | citizen class constructor surface |
| `citizen/BigIntNumberDomain` | `citizen-class` | `sim-lib-numbers-bigint` | citizen class constructor surface |
| `citizen/BoolNumberDomain` | `citizen-class` | `sim-lib-numbers-bool` | citizen class constructor surface |
| `citizen/CasNumberDomain` | `citizen-class` | `sim-lib-numbers-cas` | citizen class constructor surface |
| `citizen/Cell` | `citizen-class` | `sim-lib-mutation` | citizen class constructor surface |
| `citizen/CodecRuntime` | `citizen-class` | `sim-codec` | citizen class constructor surface |
| `citizen/CoefficientList` | `citizen-class` | `sim-lib-numbers-exotic` | citizen class constructor surface |
| `citizen/ComplexNumberDomain` | `citizen-class` | `sim-lib-numbers-complex` | citizen class constructor surface |
| `citizen/Connection` | `citizen-class` | `sim-lib-server` | citizen class constructor surface |
| `citizen/ContinuationValue` | `citizen-class` | `sim-lib-control` | citizen class constructor surface |
| `citizen/ContinuedFraction` | `citizen-class` | `sim-lib-numbers-exotic` | citizen class constructor surface |
| `citizen/ControlResultValue` | `citizen-class` | `sim-lib-control` | citizen class constructor surface |
| `citizen/CookbookStoreHandle` | `citizen-class` | `sim-lib-cookbook` | citizen class constructor surface |
| `citizen/Coroutine` | `citizen-class` | `sim-lib-server` | citizen class constructor surface |
| `citizen/ExoticNumberDomain` | `citizen-class` | `sim-lib-numbers-exotic` | citizen class constructor surface |
| `citizen/F32NumberDomain` | `citizen-class` | `sim-lib-numbers-float` | citizen class constructor surface |
| `citizen/F64NumberDomain` | `citizen-class` | `sim-lib-numbers-f64` | citizen class constructor surface |
| `citizen/FieldDomain` | `citizen-class` | `sim-lib-femm-field` | citizen class constructor surface |
| `citizen/FixedNumberDomain` | `citizen-class` | `sim-lib-numbers-fixed` | citizen class constructor surface |
| `citizen/FuncNumberDomain` | `citizen-class` | `sim-lib-numbers-func` | citizen class constructor surface |
| `citizen/GatewayEvent` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/GatewayRequest` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/GatewayResponse` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/GatewayResponseValue` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/GatewayRoutesValue` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/GatewayRun` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/GraphHandle` | `citizen-class` | `sim-lib-stream-prelude` | citizen class constructor surface |
| `citizen/I64NumberDomain` | `citizen-class` | `sim-lib-numbers-i64` | citizen class constructor surface |
| `citizen/IslispObject` | `citizen-class` | `sim-lib-lang-islisp` | citizen class constructor surface |
| `citizen/LazySequence` | `citizen-class` | `sim-lib-sequence` | citizen class constructor surface |
| `citizen/LiveCell` | `citizen-class` | `sim-lib-stream-prelude` | citizen class constructor surface |
| `citizen/LogicConfigState` | `citizen-class` | `sim-lib-logic` | citizen class constructor surface |
| `citizen/LogicDbState` | `citizen-class` | `sim-lib-logic` | citizen class constructor surface |
| `citizen/LogicStream` | `citizen-class` | `sim-lib-logic` | citizen class constructor surface |
| `citizen/LoopbackStream` | `citizen-class` | `sim-lib-agent` | citizen class constructor surface |
| `citizen/MatchHookObject` | `citizen-class` | `sim-shape` | citizen class constructor surface |
| `citizen/McpSamplingRunnerValue` | `citizen-class` | `sim-lib-mcp` | citizen class constructor surface |
| `citizen/MutableBox` | `citizen-class` | `sim-lib-mutation` | citizen class constructor surface |
| `citizen/MutableRuntimeTable` | `citizen-class` | `sim-lib-mutation` | citizen class constructor surface |
| `citizen/MutableTable` | `citizen-class` | `sim-lib-mutation` | citizen class constructor surface |
| `citizen/MutableVector` | `citizen-class` | `sim-lib-mutation` | citizen class constructor surface |
| `citizen/OpenAiGatewayFabric` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/OpenAiGatewayKey` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/OverrideTable` | `citizen-class` | `sim-table-override` | citizen class constructor surface |
| `citizen/PersistentSet` | `citizen-class` | `sim-lib-sequence` | citizen class constructor surface |
| `citizen/PersistentVector` | `citizen-class` | `sim-lib-sequence` | citizen class constructor surface |
| `citizen/ProfileSequence` | `citizen-class` | `sim-lib-sequence` | citizen class constructor surface |
| `citizen/RationalNumberDomain` | `citizen-class` | `sim-lib-numbers-rational` | citizen class constructor surface |
| `citizen/Server` | `citizen-class` | `sim-lib-server` | citizen class constructor surface |
| `citizen/ServerFrame` | `citizen-class` | `sim-lib-server` | citizen class constructor surface |
| `citizen/SkillCard` | `citizen-class` | `sim-lib-skill` | citizen class constructor surface |
| `citizen/SkillRegistry` | `citizen-class` | `sim-lib-skill` | citizen class constructor surface |
| `citizen/SkillTransportValue` | `citizen-class` | `sim-lib-skill` | citizen class constructor surface |
| `citizen/StageHandle` | `citizen-class` | `sim-lib-stream-prelude` | citizen class constructor surface |
| `citizen/StoredTableValue` | `citizen-class` | `sim-lib-openai-server` | citizen class constructor surface |
| `citizen/StreamHandle` | `citizen-class` | `sim-lib-stream-prelude` | citizen class constructor surface |
| `citizen/StreamValue` | `citizen-class` | `sim-lib-stream-core` | citizen class constructor surface |
| `citizen/TaggedValue` | `citizen-class` | `sim-lib-pattern` | citizen class constructor surface |
| `citizen/TensorLiteralClass` | `citizen-class` | `sim-lib-numbers-tensor` | citizen class constructor surface |
| `citizen/TensorNumberDomain` | `citizen-class` | `sim-lib-numbers-tensor` | citizen class constructor surface |
| `citizen/TopologyConnection` | `citizen-class` | `sim-lib-topology` | citizen class constructor surface |
| `citizen/TransducedSequence` | `citizen-class` | `sim-lib-sequence` | citizen class constructor surface |
| `citizen/TriggerHandle` | `citizen-class` | `sim-lib-server` | citizen class constructor surface |
...
| `citizen/agent/ConductContract` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/Event` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/JournalHead` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/JournalRecord` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/Outcome` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/RunFrame` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/RunState` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/StepCard` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/Stop` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/Usage` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
| `citizen/agent/UsageBudget` | `citizen-class` | `sim-lib-agent-conduct-core` | citizen class constructor surface |
...
| `citizen/continuity/Event` | `citizen-class` | `sim-lib-continuity` | citizen class constructor surface |
| `citizen/continuity/Intent` | `citizen-class` | `sim-lib-continuity` | citizen class constructor surface |
| `citizen/continuity/Plan` | `citizen-class` | `sim-lib-continuity` | citizen class constructor surface |
| `citizen/continuity/Refusal` | `citizen-class` | `sim-lib-continuity` | citizen class constructor surface |
| `citizen/continuity/RoleDemand` | `citizen-class` | `sim-lib-continuity` | citizen class constructor surface |
| `citizen/continuity/RouteLease` | `citizen-class` | `sim-lib-continuity` | citizen class constructor surface |
| `citizen/continuity/Turn` | `citizen-class` | `sim-lib-continuity` | citizen class constructor surface |
...
| `citizen/expr-tree/PolicyRecord` | `citizen-class` | `sim-lib-expr-tree` | citizen class constructor surface |
| `citizen/expr-tree/SourceRecord` | `citizen-class` | `sim-lib-expr-tree` | citizen class constructor surface |
...
| `citizen/interference/Emitter` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/Medium` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/PhasorField` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/Plane` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/Problem` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/Projection` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/ProjectionCertificate` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/ProjectionRequest` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/SamplingCertificate` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/Study` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/StudyEvidence` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
| `citizen/interference/WorkEstimate` | `citizen-class` | `sim-lib-interference-runtime` | citizen class constructor surface |
...
| `citizen/pitch/ToneRow` | `citizen-class` | `sim-lib-pitch-shapes` | citizen class constructor surface |
| `citizen/plugin-core/PluginDescriptor` | `citizen-class` | `sim-lib-plugin-core` | citizen class constructor surface |
| `citizen/provider/EndpointCard` | `citizen-class` | `sim-lib-provider` | citizen class constructor surface |
| `citizen/provider/HarnessCard` | `citizen-class` | `sim-lib-provider` | citizen class constructor surface |
| `citizen/provider/PrincipalCard` | `citizen-class` | `sim-lib-provider` | citizen class constructor surface |
| `citizen/provider/ProviderFamilyCard` | `citizen-class` | `sim-lib-provider` | citizen class constructor surface |
| `citizen/provider/ProviderSeatCard` | `citizen-class` | `sim-lib-provider` | citizen class constructor surface |
| `citizen/provider/ProviderSeatId` | `citizen-class` | `sim-lib-provider` | citizen class constructor surface |
| `citizen/provider/ProviderSeatLimits` | `citizen-class` | `sim-lib-provider` | citizen class constructor surface |
