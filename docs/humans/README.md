...
| --- | --- | ---: | --- |
| `feature/sim-sdk/neutral-conformance-packs` | `crate/sim-conformance-packs` | 2 | Expose all 21 checker entrypoints with pure evidence-driven scenarios, canonical results, and typed unavailable outcomes for scopes whose funded phase has not shipped, including canonical identity, native journal, durable operation reconciliation, semantic projection, disclosure scoping, and the real local checker boundary. |
...
- `crates/sim-conformance-packs/recipes/01-basics/bootstrap-pack/purpose.md`
- `crates/sim-conformance-packs/recipes/01-basics/bootstrap-pack/recipe.toml`
- `crates/sim-conformance-packs/recipes/01-basics/bootstrap-pack/setup.siml`
- `crates/sim-conformance-packs/recipes/01-basics/chapter.toml`
- `crates/sim-conformance-packs/recipes/book.toml`
...
### `feature/sim-sdk/neutral-conformance-packs`
...
Specimen `spec-test/sim-sdk/crates/sim-conformance-packs/tests/projection_reference` is checked by `cargo test`.

Source `crates/sim-conformance-packs/tests/projection_reference.rs`:
