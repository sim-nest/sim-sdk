...
| `feature/sim-sdk/raised-exception-composition` | `crate/sim-nest` | 0 | Expose the one non-recursive envelope, bounded class matcher, and managed relation adapter for every guest runtime. |
